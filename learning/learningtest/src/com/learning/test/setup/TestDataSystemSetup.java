 ...
 */
package com.learning.test.setup;
...
import com.learning.test.constants.LearningTestConstants;
import com.learning.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = LearningTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/learningtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/learningtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/learningtest/import/cstickets.impex");
			...
			importImpexFile(context, "/learningtest/import/csquotes.impex");
		}
	}
}
