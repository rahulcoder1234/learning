 ...
 */
package com.learning.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(LearningFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(LearningFulfilmentProcessConstants.PARENT_PROCESS);
