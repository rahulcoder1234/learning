 ...
 */
package com.learning.cockpits.setup;
...
import com.learning.cockpits.constants.LearningCockpitsConstants;
 ...
 */
@SystemSetup(extension = LearningCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(LearningCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(LearningCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						LearningCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/learningcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
