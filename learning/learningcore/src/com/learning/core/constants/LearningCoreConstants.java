...
/**
 * Global class for all LearningCore constants. You can add global constants for your extension into this class.
 */
public final class LearningCoreConstants extends GeneratedLearningCoreConstants
{
	public static final String EXTENSIONNAME = "learningcore";


	private LearningCoreConstants()
	{
		//empty
	}
